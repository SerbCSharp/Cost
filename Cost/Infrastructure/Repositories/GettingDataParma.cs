...
{
    public class GettingDataParma : IGettingData
    {
        private readonly HttpClient httpClient;
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly Base1CConfiguration _base1CConfiguration;
        public GettingDataParma(IOptions<Base1CConfiguration> base1CConfiguration, IHttpClientFactory httpClientFactory)
        {
        ...
        {
            var counterpartiesUrl = "http://localhost/PARMA/odata/standard.odata/Catalog_Контрагенты?$format=json&$select=Ref_Key,Description,Parent_Key";
        ...
        {
            var contractsCounterpartiesUrl = "http://localhost/PARMA/odata/standard.odata/Catalog_ДоговорыКонтрагентов?$format=json";
        ...
        {
            var nomenclatureGroupsUrl = "http://localhost/PARMA/odata/standard.odata/Catalog_НоменклатурныеГруппы?$format=json";
        ...
        {
            var constructionProjectsUrl = "http://localhost/PARMA/odata/standard.odata/Catalog_ОбъектыСтроительства?$format=json";
        ...
        {
            var costItemsUrl = "http://localhost/PARMA/odata/standard.odata/Catalog_СтатьиЗатрат?$format=json";
        ...
        {
            var typesCalculationsUrl = "http://localhost/PARMA/odata/standard.odata/Catalog_ВидыВзаиморасчетов?$format=json";
        ...
        {
            var debtAdjustmentUrl = "http://localhost/PARMA/odata/standard.odata/Document_КорректировкаДолга?$format=json";
        ...
        {
            var additionalInformationUrl = "http://localhost/PARMA/odata/standard.odata/InformationRegister_ДополнительныеСведения?$format=json";
        ...
        {
            var invoiceReceivedUrl = "http://localhost/PARMA/odata/standard.odata/Document_СчетФактураПолученный?$format=json";
        ...
        {
            var operationUrl = "http://localhost/PARMA/odata/standard.odata/Catalog_ДоговорыКонтрагентов?$format=json&$select=Дата,Code";
        ...
        {
            var operationUrl = "http://localhost/PARMA/odata/standard.odata/Document_ОперацияБух?$format=json";
            using HttpResponseMessage operationResponse = await httpClient.GetAsync(operationUrl);
        ...
        {
            var billPaymentUrl = "http://localhost/PARMA/odata/standard.odata/AccumulationRegister_ОплатаСчетов?$format=json";
